...
function DashboardCard08({ selectedDate }) {
  ...
  useEffect(() => {
    const handleFetch = async () => {
      ...
      axios.get(`https://nair-social-media-analytics-production.up.railway.app/api/v1/user/facebook/pages/page-impressions?since=${formattedSinceDate}&until=${formattedUntilDate}`, {
        headers: {
          'Authorization': auth,
